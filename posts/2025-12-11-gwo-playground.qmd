...
This playground visualizes the **Grey Wolf Optimization (GWO)** algorithm. The wolves (particles) attempt to find the global minimum of the **Rastrigin Function** (located at `[0, 0]`).
